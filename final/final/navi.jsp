...
<% 
	...
	Statement st1 = null;
	ResultSet rs1 = null;
	String did=null, name=null, pass=null, email=null,mobile=null,quali=null, des=null, sex=null, sal=null;

	try{
		Class.forName("com.mysql.jdbc.Driver");
      con1 = DriverManager.getConnection(DB_URL,USER,PASS);
	    st1=con1.createStatement();
		String sql1="select doc_id,name,pass,qualification,designation,email,mobile,salary,sex from doctor order by doc_id";
...
%>
      <td> <a href="docdelete.jsp?<%=did%>">Delete</a></td>
